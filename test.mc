  ...
  lam input1.
    lam #var"5".
      rejectAccept
        ...
        input1.dMean
in
let input = { symbiont_tree = Node { age = 0.0, left = Leaf { label = 1, age = 0.0 }, right = Leaf { label = 2, age = 0.0 }, label = 0}, ntips = 2, nhosts = 1, interactions = [1, 1], host_distances = [1.], dMean = 1.} in
let tmp = anon38 input {} in
dprint tmp
